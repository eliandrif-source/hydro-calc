...
assert.match(sw, /CACHE_NAME\s*=\s*'hydrocalc-v300-security-20260902'/);
...
console.log('pwa-security: same-origin isolation, network-first critical assets and offline shell regressions OK');

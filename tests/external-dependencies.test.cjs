...
const html = fs.readFileSync(path.join(__dirname, '..', 'HydroCalc_Design_Unifie.html'), 'utf8');
...
const dependencyDoc = fs.readFileSync(path.join(__dirname, '..', 'docs', 'DEPENDENCY_SECURITY.md'), 'utf8');
...
console.log('external-dependencies: reviewed CDN inventory is frozen and documented');
